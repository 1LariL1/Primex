                ...
                <div class="personal-info">
                    ...
                    <div class="personal-info__wrapper">
                        <div class="personal-info__input">
                            ...
                            <div class="personal-info__input-div">
                                <p class="account-input"><?= $_SESSION['user']['login'] ?></p>
                            </div>
                        </div>
                        <div class="personal-info__input">
                            <h3 class="title10">Email</h3>
                            <div class="personal-info__input-div">
                                <p class="account-input"><?= $_SESSION['user']['email'] ?></p>
                            </div>
                        </div>
                        <div class="personal-info__input-last">
                            <h3 class="title10">ФИО</h3>
                            <div class="personal-info__input-div">
                                <p class="account-input"><?= $_SESSION['user']['full_name'] ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="personal-info__wrapper">
                        <div class="personal-info__input">
                            ...
                            <div class="personal-info__input-div">
                                <p class="account-input"><?= $_SESSION['user']['telephone'] ?></p>
                            </div>
                        </div>
                        <div class="personal-info__input">
                            <h3 class="title10">Пароль</h3>
                            <div class="personal-info__input-button-div">
                                <div class="personal-info__input-div">
                                    <p class="account-input">********</p>
                                </div>
