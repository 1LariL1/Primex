<?php
    ...
    $id_service = $_GET['id'];
    $service = mysqli_query($connect, query:"SELECT * FROM `service` WHERE `id_service` = '$id_service'");
...
<body style="background-color: #252525">
    ...
    <main>
        <div class="container container1">
            ...
            <form action="/php/update/update-service.php" method="post">
                <div class="admin-box">
                    ...
                    <div class="admin-wrap">
                        ...
                        <input type="text" name="serviceName" class="admin-input" required value="<?= $service['service']?>">
                    </div>
                    ...
                    <div class="admin-wrap">
                        ...
                        <input type="number" name="servicePrice" class="admin-input" required value="<?= $service['price']?>">
                    </div>
                    ...
                    <div class="admin-wrap">
                        ...
                        <input type="text" name="serviceDesc" class="admin-input" required value="<?= $service['description']?>">
                    </div>
                </div>
