            ...
            <form action="/php/update/update-user.php" method="post">
                <div class="admin-box">
                    ...
                    <div class="admin-wrap">
                        ...
                        <input type="text" name="userLogin" class="admin-input" required value="<?= $user['login']?>">
                    </div>
                    ...
                    <div class="admin-wrap">
                        ...
                        <input type="text" name="userFIO" class="admin-input" required value="<?= $user['full_name']?>">
                    </div>
                    ...
                    <div class="admin-wrap">
                        ...
                        <input type="text" name="userPass" class="admin-input" required value="<?= $user['password']?>">
                    </div>
                    ...
                    <div class="admin-wrap">
                        ...
                        <input type="tel" name="userTel" class="admin-input" required value="<?= $user['telephone']?>">
                    </div>
                </div>
