                    ...
                    <div class="services__catalog">
                        <div class="services__catalog-one">
                            <div class="services__one">
                                <h3 class="title7">Уборка внутренних помещений</h3>
                                <p class="paragraph2">Ежедневная;
                                    <br>Послестроительная;
                                    <br>Генеральная;
                                    <br>Гигиеническая;
                                    <br>Быстрая;
                                    <br>Профессиональная;
                            ...
                            <div class="services__two">
                                <h3 class="title7">Специализированные услуги</h3>
                                <p class="paragraph2">Дезинфекция; 
                                    <br>Дезинфекция от COVID; 
                                    <br>Дератизация.</p>
                            </div>
                            </div>
                        </div>
                        <div class="services__catalog-two">
                            <div class="services__three">
                                <h3 class="title7">Уборка прилегающей 
                                    <br>территории</h3>
                                <p class="paragraph2">Зимняя; 
                                    <br>Комплексная; 
                                    <br>Уборка снега; 
                                    <br>Вывоз снега; 
                                    <br>Мойка фасада; 
                                    <br>Сбор и вывоз мусора.</p>
                            </div>
                            <div class="services__four">
                                <h3 class="title7">Частный сектор (услуги 
                                    <br>физическим лицам)</h3>
                                <p class="paragraph2">Мойка окон; 
                                    <br>Химчистка мебели; 
                                    <br>Генеральная уборка; 
                                    <br>Послестроительная уборка.</p>
                            </div>
                        </div>
                    </div>
                </div>
